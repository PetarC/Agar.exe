...
namespace Hydra
{
    ...
    Angle Vector3D::getAngleX() const
    {
        Angle angle;
        angle.setRads(acosf(xComp / getMag()));
        return angle;
    }
    Angle Vector3D::getAngleY() const
    {
        Angle angle;
        angle.setRads(acosf(yComp / getMag()));
        return angle;
    }
    Angle Vector3D::getAngleZ() const
    {
        Angle angle;
        angle.setRads(acosf(zComp / getMag()));
        return angle;
    }
